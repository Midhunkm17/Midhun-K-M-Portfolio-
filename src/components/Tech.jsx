    ...
    >
      ...
      <div className="flex flex-wrap items-center justify-center gap-10 p-5">
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <BiLogoNodejs className="cursor-pointer text-[80px] text-yellow-500 transition-all duration-300 hover:-translate-y-5 sm:text-[100px] md:text-[120px]" />
        </motion.div>
        <motion.div
          variants={variants}
          initial="hidden"
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <BiLogoRedux className="cursor-pointer text-[80px] text-violet-500 transition-all duration-300 hover:-translate-y-5 sm:text-[100px] md:text-[120px]" />
        </motion.div>
      </div>
    </div>
  );
